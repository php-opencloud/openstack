        ...
        if (isset($data['user'])) {
            ...
            if (!isset($data['user']['id']) && empty($data['user']['domain'])) {
                throw new InvalidArgumentException(
                    'When authenticating with a username, you must also provide either the domain name '
                    . 'or domain ID to which the user belongs to. Alternatively, if you provide a user ID instead, '
                    . 'you do not need to provide domain information.');
            }
        }
